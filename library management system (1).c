...
void returnfunc(void);//me
void mainmenu(void);
void addbooks(void);//me
void deletebooks(void);//akshit
void editbooks(void);//amar
void searchbooks(void);//me
void issuebooks(void);//satya
void viewbooks(void);//akshit
void closeapplication(void);
int  getdata();//amar
int  checkid(int);//amar
int t(void);//satya
void Password();//omkar
void issuerecord();//omkar
